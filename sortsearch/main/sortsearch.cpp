...
int main()
{
    ...
    cout << prueba->search(listNumbers, 10);
    cout << prueba->search(listNumbers, 35);
    cout << prueba->search(listNumbers, 20);
    cout << prueba->search(listNumbers, 22);
    cout << prueba->search(listNumbers, 9);
}